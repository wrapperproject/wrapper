...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Wrapper is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Wrapper is downloading blocks...");
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    BOOST_FOREACH (CTransaction& tx, pblock->vtx)
    {
        ...
        // https://github.com/wrapperofficial/wrapper/pull/26
...
Value getworkaux(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Wrapper is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Wrapper is downloading blocks...");
