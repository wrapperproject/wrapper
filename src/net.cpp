...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "wrapper " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"178.62.52.47", "178.62.52.47"},
    {"us3.minerhub.io", "us3.minerhub.io"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. wrapper is probably already running."), addrBind.ToString().c_str());
        else
